# Week 4 extension mini-essays

Covers **lectures 7 and 8**. Due **2026-09-28, 23:59**.

Add one file: `week4/week4-<yourname>-ext.html`, where `<yourname>` is your Latin name
in lowercase with no spaces (for example `week4/week4-tongli-ext.html`). Start from
