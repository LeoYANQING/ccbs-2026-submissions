# Week 8 extension mini-essays

Covers **lectures 15 and 16**. Due **2026-11-02, 23:59**.

Add one file: `week8/week8-<yourname>-ext.html`, where `<yourname>` is your Latin name
in lowercase with no spaces (for example `week8/week8-tongli-ext.html`). Start from
